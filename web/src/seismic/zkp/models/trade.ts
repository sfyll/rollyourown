...
export default class Trade {
   ...
   */
  private static async createTrade(
    reserve_in: bigint,
    reserve_out: bigint,
    amountIn: bigint,
    amountInRoundedDown: bigint,
  ...
  public getNewReserveIn(): bigint {
    return this.pool.reserve_in + this.amountIn;
  }

  public getNewReserveOut(): bigint {
    return this.pool.reserve_out + this.amountOut;
  }
