...
export type BlindedMarketPricesQuery = {
  __typename?: "World__Query";
  blindedMarketModels?: {
    __typename?: "BlindedMarketConnection";
    edges?: Array<{
...
export type LeaderboardMetasQuery = {
  __typename?: "World__Query";
  leaderboardModels?: {
    __typename?: "LeaderboardConnection";
    edges?: Array<{
...
export type PlayerPropsFragment = {
  __typename?: "Player";
  name?: any | null;
  avatar_id?: any | null;
  mainnet_address?: any | null;
  cash?: any | null;
  status?: any | null;
  hood_id?: any | null;
  location_id?: any | null;
    ...
    edges?: Array<{
      ...
      node?: {
        ...
        models?: Array<
          ...
          | {
              __typename: "Encounter";
              encounter_id?: any | null;
              level?: any | null;
              health?: any | null;
              payout?: any | null;
            }
          | { __typename: "Game" }
          | { __typename: "Item"; item_id?: any | null; level?: any | null; name?: any | null; value?: any | null }
          | { __typename: "Leaderboard" }
          | { __typename: "Market" }
          | {
              __typename: "Player";
...
export type PlayerEntitySubscriptionSubscription = {
  __typename?: "World__Subscription";
  entityUpdated: {
    __typename?: "World__Entity";
    id?: string | null;
...
export const GlobalScoresDocument = `
  ...
  playerModels(
    ...
    `;
export const useGlobalScoresQuery = <TData = GlobalScoresQuery, TError = unknown>(
...
useGlobalScoresQuery.getKey = (variables?: GlobalScoresQueryVariables) =>
  variables === undefined ? ["GlobalScores"] : ["GlobalScores", variables];
export const useInfiniteGlobalScoresQuery = <TData = GlobalScoresQuery, TError = unknown>(
  variables?: GlobalScoresQueryVariables,
...
useInfiniteGlobalScoresQuery.getKey = (variables?: GlobalScoresQueryVariables) =>
  variables === undefined ? ["GlobalScores.infinite"] : ["GlobalScores.infinite", variables];
export const MarketPricesDocument = `
  ...
  marketModels(first: 36, where: {game_id: $gameId}) {
    ...
    `;
export const useMarketPricesQuery = <TData = MarketPricesQuery, TError = unknown>(
...
useMarketPricesQuery.getKey = (variables?: MarketPricesQueryVariables) =>
  variables === undefined ? ["MarketPrices"] : ["MarketPrices", variables];
export const useInfiniteMarketPricesQuery = <TData = MarketPricesQuery, TError = unknown>(
  variables?: MarketPricesQueryVariables,
...
useInfiniteMarketPricesQuery.getKey = (variables?: MarketPricesQueryVariables) =>
  variables === undefined ? ["MarketPrices.infinite"] : ["MarketPrices.infinite", variables];
export const BlindedMarketPricesDocument = `
  ...
  blindedMarketModels(first: 36, where: {game_id: $gameId}) {
    ...
    `;
export const useBlindedMarketPricesQuery = <TData = BlindedMarketPricesQuery, TError = unknown>(
  ...
  useQuery<BlindedMarketPricesQuery, TError, TData>(
    ...
    useFetchData<BlindedMarketPricesQuery, BlindedMarketPricesQueryVariables>(BlindedMarketPricesDocument).bind(
      null,
      variables,
    ),
    options,
...
useBlindedMarketPricesQuery.getKey = (variables?: BlindedMarketPricesQueryVariables) =>
  variables === undefined ? ["BlindedMarketPrices"] : ["BlindedMarketPrices", variables];
export const useInfiniteBlindedMarketPricesQuery = <TData = BlindedMarketPricesQuery, TError = unknown>(
  variables?: BlindedMarketPricesQueryVariables,
...
useInfiniteBlindedMarketPricesQuery.getKey = (variables?: BlindedMarketPricesQueryVariables) =>
  variables === undefined ? ["BlindedMarketPrices.infinite"] : ["BlindedMarketPrices.infinite", variables];
export const RyoMetasDocument = `
  ...
  ryoMetaModels(limit: 1) {
    ...
    `;
export const useRyoMetasQuery = <TData = RyoMetasQuery, TError = unknown>(
...
useRyoMetasQuery.getKey = (variables?: RyoMetasQueryVariables) =>
  variables === undefined ? ["RyoMetas"] : ["RyoMetas", variables];
export const useInfiniteRyoMetasQuery = <TData = RyoMetasQuery, TError = unknown>(
  variables?: RyoMetasQueryVariables,
...
useInfiniteRyoMetasQuery.getKey = (variables?: RyoMetasQueryVariables) =>
  variables === undefined ? ["RyoMetas.infinite"] : ["RyoMetas.infinite", variables];
export const LeaderboardMetasDocument = `
  ...
  leaderboardModels(where: {version: $version}) {
    ...
    `;
export const useLeaderboardMetasQuery = <TData = LeaderboardMetasQuery, TError = unknown>(
...
useLeaderboardMetasQuery.getKey = (variables?: LeaderboardMetasQueryVariables) =>
  variables === undefined ? ["LeaderboardMetas"] : ["LeaderboardMetas", variables];
export const useInfiniteLeaderboardMetasQuery = <TData = LeaderboardMetasQuery, TError = unknown>(
  variables?: LeaderboardMetasQueryVariables,
...
useInfiniteLeaderboardMetasQuery.getKey = (variables?: LeaderboardMetasQueryVariables) =>
  variables === undefined ? ["LeaderboardMetas.infinite"] : ["LeaderboardMetas.infinite", variables];
...
export const usePlayerEntityQuery = <TData = PlayerEntityQuery, TError = unknown>(
...
export const useInfinitePlayerEntityQuery = <TData = PlayerEntityQuery, TError = unknown>(
  variables: PlayerEntityQueryVariables,
...
export const LocationEntitiesDocument = `
  ...
  entities(keys: [$gameId, $locationId]) {
    ...
    `;
export const useLocationEntitiesQuery = <TData = LocationEntitiesQuery, TError = unknown>(
...
export const useInfiniteLocationEntitiesQuery = <TData = LocationEntitiesQuery, TError = unknown>(
  variables: LocationEntitiesQueryVariables,
...
useInfiniteLocationEntitiesQuery.getKey = (variables: LocationEntitiesQueryVariables) => [
  "LocationEntities.infinite",
  variables,
];
export const PlayerLogsDocument = `
  ...
  events(last: 1000, keys: ["*", $game_id, $player_id]) {
    ...
    `;
export const usePlayerLogsQuery = <TData = PlayerLogsQuery, TError = unknown>(
...
export const useInfinitePlayerLogsQuery = <TData = PlayerLogsQuery, TError = unknown>(
  variables: PlayerLogsQueryVariables,
